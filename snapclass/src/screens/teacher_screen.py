...
from src.components.photo_dialog import add_photo_dialog
import numpy as np
...
def teacher_screen_login():
    ...
    with c1:
        header_dashboard()
    with c2:
     if st.button("Go Back to Home",type='secondary',key='loginbacktohomebtn',shortcut="control+backspace"):
    ...
    teacher_username=st.text_input("Enter username",placeholder='shwetakanak')
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter username",placeholder='@shwetakanak')
    teacher_name=st.text_input("Enter name",placeholder='Shweta Kanak')
    teacher_password=st.text_input("Enter password",type='password',placeholder='Enter your password')
